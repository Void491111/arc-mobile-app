...
class _EditLabelDialogState extends State<EditLabelDialog> {
  ...
  Widget build(BuildContext context) {
    return Dialog(
      ...
      // Ubah padding bawahnya jadi kecil (10) biar gak jepret pas keyboard naik boss
      insetPadding: const EdgeInsets.only(top: 50.0, bottom: 10.0, left: 24.0, right: 24.0),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      backgroundColor: Colors.white,
      child: SingleChildScrollView( // <-- Penawar overflow keyboard
